...
Fanvue rules forbid facilitation of on-platform transaction in a manner that evade platform fees. And, neither Discord nor Fanvue have electronic money licences. For this reason, never offer a 100% off Fanvue subscription in exchange of a Discord boost or a Discord Creator SKU. Similarly, never offer 100% off Fanvue subscriptions in exchange for paying to register a Matrix homeserver. Partial discounts or VIP lists are usually okay, as they still encourage the member to spend in the Fanvue side. And similarly, never offer 100% off a Discord Creator SKU in exchange of a Fanvue subscription. For the same reason, we didn't offer those features natively. 
